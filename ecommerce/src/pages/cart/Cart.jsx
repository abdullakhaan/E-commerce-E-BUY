...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "pk_test_51QG24PJn0VkJg9yosZa1fecbXmltSnXEBwhxd546LN9vPEJZXItyKx2G76GotRs4Vtte3Y119WTgItoQ9KJAWqSf00SDKbWN3s",
      key_secret: "sk_test_51QG24PJn0VkJg9yo5dnveFtFD6vMnzodTpWXpMWG6G4QkXQ2GGq0QgommxhzkMjCt2jeePSLHBb7KkN56Pvt0ckX00wWCivTj6",
      ...
      handler: function (response) {
        ...
        const paymentId = response.stripe_payment_id;
        // store in firebase
        const orderInfo = {
          cartItems,
          addressInfo,
